...
/* DacOutput */
#define DacOutput__0__INTTYPE CYREG_PICU3_INTTYPE7
#define DacOutput__0__MASK 0x80u
#define DacOutput__0__PC CYREG_PRT3_PC7
#define DacOutput__0__PORT 3u
#define DacOutput__0__SHIFT 7u
#define DacOutput__AG CYREG_PRT3_AG
#define DacOutput__AMUX CYREG_PRT3_AMUX
#define DacOutput__BIE CYREG_PRT3_BIE
#define DacOutput__BIT_MASK CYREG_PRT3_BIT_MASK
#define DacOutput__BYP CYREG_PRT3_BYP
#define DacOutput__CTL CYREG_PRT3_CTL
#define DacOutput__DM0 CYREG_PRT3_DM0
#define DacOutput__DM1 CYREG_PRT3_DM1
#define DacOutput__DM2 CYREG_PRT3_DM2
#define DacOutput__DR CYREG_PRT3_DR
#define DacOutput__INP_DIS CYREG_PRT3_INP_DIS
#define DacOutput__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU3_BASE
#define DacOutput__LCD_COM_SEG CYREG_PRT3_LCD_COM_SEG
#define DacOutput__LCD_EN CYREG_PRT3_LCD_EN
#define DacOutput__MASK 0x80u
#define DacOutput__PORT 3u
#define DacOutput__PRT CYREG_PRT3_PRT
#define DacOutput__PRTDSI__CAPS_SEL CYREG_PRT3_CAPS_SEL
#define DacOutput__PRTDSI__DBL_SYNC_IN CYREG_PRT3_DBL_SYNC_IN
#define DacOutput__PRTDSI__OE_SEL0 CYREG_PRT3_OE_SEL0
#define DacOutput__PRTDSI__OE_SEL1 CYREG_PRT3_OE_SEL1
#define DacOutput__PRTDSI__OUT_SEL0 CYREG_PRT3_OUT_SEL0
#define DacOutput__PRTDSI__OUT_SEL1 CYREG_PRT3_OUT_SEL1
#define DacOutput__PRTDSI__SYNC_OUT CYREG_PRT3_SYNC_OUT
#define DacOutput__PS CYREG_PRT3_PS
#define DacOutput__SHIFT 7u
#define DacOutput__SLW CYREG_PRT3_SLW
